...
Baseline Data
-------------
NLM produces a baseline set of MEDLINE/PubMed citation records in XML format for download on an annual basis. The annual baseline is released in December of each year. The complete baseline consists of files pubmed21n0001 through pubmed21n1062. 
ftp://ftp.ncbi.nlm.nih.gov/pubmed/baseline 
Daily Update Files
------------------
Each day, NLM produces update files that include new, revised and deleted citations. The first Update file to be loaded after loading the complete set of 2021 MEDLINE/PubMed Baseline files is pubmed21n1063.xml. 
